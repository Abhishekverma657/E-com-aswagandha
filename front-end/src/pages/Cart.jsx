...
export default function Cart() {
  ...
  return (
    <div className="bg-secondary min-h-screen pt-[184px] pb-24">
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="w-full lg:w-2/3">
            ...
            <div className="space-y-8">
              {cartItems.map((item) => (
                <div key={item.id} className="grid grid-cols-1 md:grid-cols-6 gap-6 items-center border-b border-primary/5 pb-8 animate-fade-in-up bg-secondary p-5 rounded-sm shadow-xs border border-primary/5">
