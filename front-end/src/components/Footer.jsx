        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center pb-12 border-b border-[#e6e2d6] gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <a href={content?.footer?.socialLinks?.facebook || "#"} className="w-8 h-8 rounded-full bg-blue-600 text-white flex items-center justify-center hover:bg-blue-700 transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href={content?.footer?.socialLinks?.instagram || "#"} className="w-8 h-8 rounded-md bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 text-white flex items-center justify-center hover:opacity-90 transition-opacity">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              <a href={content?.footer?.socialLinks?.twitter || "#"} className="w-8 h-8 rounded-sm bg-blue-700 text-white flex items-center justify-center hover:bg-blue-800 transition-colors">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex items-start gap-2 text-gray-600 font-sans font-light text-sm">
                  ...
                  <span style={{ whiteSpace: 'pre-wrap' }}>{content?.footer?.address || "Nagaur, Rajasthan\nIndia - 341001"}</span>
                </div>
              </div>
            </div>
